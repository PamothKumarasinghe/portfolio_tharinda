...
import { FolderOpen, Briefcase, GraduationCap, Code, LogOut, Plus, FileText, Award } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  const sections = [
    ...
    { name: 'Interests', icon: Award, color: '#0077b6', path: '/admin/interests' },
    { name: 'CV Manager', icon: FileText, color: '#023e8a', path: '/admin/cv' },
  ];
